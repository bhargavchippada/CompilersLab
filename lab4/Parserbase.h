...
// $insert polymorphicSpecializations
    ...
    template <>
    struct TagOf<ForStmt*>
    {
        static Tag__ const tag = Tag__::ForStmt;
    };
    ...
    template <>
    struct TagOf<emptyStmt*>
    {
        static Tag__ const tag = Tag__::emptyStmt;
    };

    template <>
    struct TagOf<IfStmt*>
    {
        static Tag__ const tag = Tag__::IfStmt;
    };

    template <>
    struct TagOf<AssStmt*>
    {
        static Tag__ const tag = Tag__::AssStmt;
    };

    template <>
    struct TagOf<BlockStmt*>
    {
        static Tag__ const tag = Tag__::BlockStmt;
    };

    template <>
    struct TagOf<FUNCALL*>
    {
        static Tag__ const tag = Tag__::FUNCALL;
    };

    template <>
    struct TagOf<op1*>
    {
        static Tag__ const tag = Tag__::op1;
    };
    ...
    template <>
    struct TagOf<WhileStmt*>
    {
        static Tag__ const tag = Tag__::WhileStmt;
    };

    template <>
    struct TagOf<STRINGCONST*>
    {
    ...
    template <>
    struct TagOf<list<StmtAst*>*>
    {
        static Tag__ const tag = Tag__::STMTLIST;
    };
    ...
    struct TagOf<op2*>
    {
        static Tag__ const tag = Tag__::op2;
    };

    template <>
    struct TagOf<FLOATCONST*>
    {
        static Tag__ const tag = Tag__::FLOATCONST;
    };

    template <>
    struct TagOf<ReturnStmt*>
    {
        static Tag__ const tag = Tag__::ReturnStmt;
    };

    template <>
    struct TagOf<IDENTIFIERAST*>
    {
        static Tag__ const tag = Tag__::IDENTIFIERAST;
    };

    template <>
    struct TagOf<list<ExpAst*>*>
    {
        static Tag__ const tag = Tag__::EXPLIST;
    };

    template <>
    struct TagOf<ArrayRef*>
    {
        static Tag__ const tag = Tag__::ArrayRef;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::ForStmt>
    {
        typedef ForStmt* DataType;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::emptyStmt>
    {
        typedef emptyStmt* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::IfStmt>
    {
        typedef IfStmt* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::AssStmt>
    {
        typedef AssStmt* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::BlockStmt>
    {
        typedef BlockStmt* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::FUNCALL>
    {
        typedef FUNCALL* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::op1>
    {
        typedef op1* DataType;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::WhileStmt>
    {
        typedef WhileStmt* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::STRINGCONST>
    {
        typedef STRINGCONST* DataType;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::STMTLIST>
    {
        typedef list<StmtAst*>* DataType;
    };
    ...
    {
        typedef INTCONST* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::op2>
    {
        typedef op2* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::FLOATCONST>
    {
        typedef FLOATCONST* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::ReturnStmt>
    {
        typedef ReturnStmt* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::IDENTIFIERAST>
    {
        typedef IDENTIFIERAST* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::EXPLIST>
    {
        typedef list<ExpAst*>* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::ArrayRef>
    {
        typedef ArrayRef* DataType;
    };
